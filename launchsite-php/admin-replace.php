...
step('🖼️', 'Regenerating catalog thumbnail…');
$thumb_ok = generate_thumbnail(
    $template_id, $meta['name'], $meta['accent'], $meta['dark'], $meta['light'],
    $meta['hero_tagline'], $thumbs_dir
);
if ($thumb_ok) {
    step('✅', 'Thumbnail regenerated');
} else {
    step('⚠️', "Thumbnail skipped (GD unavailable) — update manually at <code>assets/img/thumbs/$template_id.jpg</code>");
}
