...
<head>
    ...
    <title><?php echo isset($page_title) ? htmlspecialchars($page_title) . ' — LaunchSite by Certxa' : 'LaunchSite by Certxa'; ?></title>
    ...
    <div class="container">
        <nav class="navbar">
            ...
            <div class="nav-links">
                ...
                <a href="https://certxa.com/launchsite.php" class="nav-link nav-link--active">LaunchSite</a>
            ...
            <div class="nav-actions">
                ...
                <a href="https://certxa.com/signup" class="btn btn--primary">Start Free Trial</a>
            </div>
        ...
        <div class="mobile-menu" id="mobileMenu">
            ...
            <a href="https://certxa.com/launchsite.php" class="mobile-nav-link">LaunchSite</a>
            ...
            <a href="https://certxa.com/signup" class="btn btn--primary" style="margin-top:1rem;display:inline-block;">Start Free Trial</a>
        </div>
    </div>
</header>
